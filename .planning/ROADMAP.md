...
- [ ] Phase 11: Global Install + Status Subcommand — `uv tool install` exposes a global `ngtui`; key-less `ngtui status --json` emits Waybar JSON — DESK-01, DESK-02
...
| 11. Global Install + Status Subcommand | v2.1 | 0/? | Not started | — |
