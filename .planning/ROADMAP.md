...
**Plans**: 4 plans
  - [ ] 03-01-PLAN.md — Parity & probe gate: runtime state-verify check + fd-lock presence probe spike (GARD-03, GARD-05)
  - [ ] 03-02-PLAN.md — Guard core: config verify/circuit-breaker/revert/maximal-lockout + state worst-case (GARD-01, GARD-02, GARD-03, GARD-05)
...
| 3. Enforcement Guard | 0/4 | Not started | - |
