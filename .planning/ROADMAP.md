...
**Plans**: 5 plans
  - [ ] 04-01-PLAN.md — Scaffold Tauri v2 (vanilla-TS + Vite) shell as 3rd workspace member + fixed IPC contract (4 commands + DTOs + IpcError + AppCtx) (UI-01, UI-02, UI-03, UI-04)
  - [ ] 04-02-PLAN.md — TDD: pure lock_status curfew-window evaluator in mutation-engine (highest-risk net-new logic) (UI-01)
...
| 4. UI (Moonlit Indigo) | 0/5 | Not started | - |
